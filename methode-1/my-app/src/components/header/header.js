...
const Header = () => {
    ...
    const fetchEmailAccounts = async () => {
        try {
            const response = await axios.get('https://smtp-1-z9is.onrender.com/email-accounts');
    ...
    const handleDeleteEmailAccount = async (emailUser) => {
        try {
            const response = await axios.delete('https://smtp-1-z9is.onrender.com/delete-email-account', { data: { user: emailUser } });
  ...
  const uploadedSMTP = (event) => {
    ...
    const handleSendEmails = () => {
        ...
        axios.post('https://smtp-1-z9is.onrender.com/send-emails', { recipients: emails, subject: emailSubject, body: emailBody, batchSize: batchSize, fromEmail: fromEmail })
            .then(response => {
            ...
            const eventSource = new EventSource('https://smtp-1-z9is.onrender.com/email-progress');
 ...
 const handleAddEmailAccount = async () => {
        ...
        try {
            const response = await axios.post('https://smtp-1-z9is.onrender.com/add-email-account', accountsToAdd);
    ...
    const handleTestSMTP = async (account) => {
        ...
        try {
            const response = await axios.post('https://smtp-1-z9is.onrender.com/test-smtp', {
                user: account.user,
                pass: account.pass,
                host: account.host,
                port: account.port,
